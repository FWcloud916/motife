...
- [x] Pick 3 concepts for the eval set (suggested: JWT auth flow, message queue backpressure, DB index internals) — concepts the author can personally judge for quality
